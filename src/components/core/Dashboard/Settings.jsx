...
const Settings = () => {
	...
	const pfp = useSelector(
		(state) => state.profile.user.image
	);
		...
		<div>
			<div className=" flex-1 overflow-auto">
				<div className="mx-auto w-11/12 max-w-[1000px] py-10">
					...
					{/* update additional info */}
					<form
						onSubmit={handelAdditionalDetails}>
					...
					<div className="my-10 flex flex-row gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900 p-3 md:p-8 md:px-12">
						...
						<div className="flex flex-col space-y-2 w-full">
							...
							<div className="md:w-3/5 text-pink-25">
								...
								<p>
									This account may contain Paid
									Courses. Deleting your account
									is permanent and will remove all
