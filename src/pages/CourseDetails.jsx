...
const CourseDetails = () => {
	...
	const [avgReviewCount, setAvgReviewCount] =
		useState(0);
	const [alreadyEnrolled, setAlreadyEnrolled] =
		useState(false);
	...
	useEffect(() => {
		if (courseDetail) {
			const Enrolled =
				courseDetail?.studentsEnrolled?.find(
			...
			<div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
				<div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
					...
					<div className="max-w-[830px] ">
						...
						<div className="py-4">
							{courseDetail?.courseContent?.map(
								(item, index) => (
									<details
										key={index}
			...
			<div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
				<div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[990px]">
					<div className="my-8 border border-richblack-600 p-3 md:p-8">
						...
						{courseDetail?.ratingAndReviews?.map(
							(item, index) => (
								<div
									key={index}
